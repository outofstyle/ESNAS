...
class SurrogateModel:
    ...
    def _fetch(self, **kwargs):
        if self.method == 'rbf':
            ...
            """ use with caution, might not work with one-hot encoding """
            from surrogate_models.rbf import RBFEnsemble
            return RBFEnsemble()
            ...
            from surrogate_models.carts import CART
        ...
        elif self.method == 'knns':
            from surrogate_models.knns import KnnEnsemble
            return KnnEnsemble()
        elif self.method == 'knne':
            from surrogate_models.knne import KnnEnsemble
            return KnnEnsemble()
        else:
